...
def interpByYbrick(X_train, y_train,X_test, y_test,X_topFeats,ls_2ProTypeNames,
    ...
    plt.savefig(p_figName,dpi=300,bbox_inches="tight",pad_inches = 1)
    plt.savefig(p_figName_p,pad_inches = 1)
    plt.clf()
    plt.close()
    ...
    plt.savefig(p_figName,dpi=300,pad_inches = 1)
    plt.savefig(p_figName_p,pad_inches = 1)
    plt.clf()
    plt.close()
...
def mainPlotFun(df_train_X, df_test_X, arr_train_y, arr_test_y, df_X_resampd,arr_y_resampd,
    ...
    plt.savefig(p_figName,dpi=300,pad_inches = 1)
    plt.savefig(p_figName_p,dpi=300,pad_inches = 1)
    plt.clf()
    plt.close()
